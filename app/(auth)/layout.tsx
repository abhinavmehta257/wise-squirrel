  ...
  return (
    <>
      ...
      <main className="relative flex grow">
        ...
        <>
          {/* Right side */}
          <div className="relative my-6 mr-6 hidden w-[572px] shrink-0 overflow-hidden rounded-2xl lg:flex lg:justify-center items-center">
            {/* Background */}
            <div
            ...
            <Image src={authImg} alt="Auth bg" className="p-2"></Image>
          </div>
        </>
      </main>
    </>
