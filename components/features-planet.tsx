...
import PlanetImg from "@/public/images/Galileo design.png";
      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="mx-auto max-w-3xl pb-16 text-center md:pb-20">
            ...
            <p className="mb-8 text-lg text-gray-200 aos-init aos-animate">Whether it&#39;s an article, video, or social media post, <b>wise squirrel </b> helps you gather all your saved content across platforms into one intuitive dashboard.</p>
          </div>
          {/* Planet */}
          ...
          <div className="grid overflow-hidden sm:grid-cols-2 lg:grid-cols-3 [&>*]:relative [&>*]:p-6 [&>*]:before:absolute [&>*]:before:bg-gray-800 [&>*]:before:[block-size:100vh] [&>*]:before:[inline-size:1px] [&>*]:before:[inset-block-start:0] [&>*]:before:[inset-inline-start:-1px] [&>*]:after:absolute [&>*]:after:bg-gray-800 [&>*]:after:[block-size:1px] [&>*]:after:[inline-size:100vw] [&>*]:after:[inset-block-start:-1px] [&>*]:after:[inset-inline-start:0] md:[&>*]:p-10">
            <article>
              ...
              Stop wasting time switching between apps. With Wise Squirrel, your saved bookmarks, articles, videos, and more are all neatly organized in one place.
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
              ...
              <p className="text-[15px] text-gray-400">
              Find exactly what you&#39;re looking for with ease. Just type in a keyword, and Wise Squirrel will search through all your connected services in seconds.
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
                ...
                <span>Connect Your Favorite Platforms</span>
              </h3>
              <p className="text-[15px] text-gray-400">
                From social media posts to news articles, you can link Wise Squirrel to all the services you use, including Reddit, Twitter, and more. All your bookmarks, under one roof.
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
              ...
              <p className="text-[15px] text-gray-400">
              Automatically categorize your saves based on type—articles, videos, podcasts—making it easier than ever to find what you need, when you need it.
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
              ...
              <p className="text-[15px] text-gray-400">
                We value your privacy. Your data is yours to keep. We securely manage your connections without storing unnecessary information.
              </p>
            </article>
          </div>
        </div>
